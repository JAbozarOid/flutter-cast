  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromSize(
            bounds: Rect.fromLTWH(-1064.0, 156.9, 1768.0, 483.1),
            ...
            child:
              ...
              children: <Widget>[
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(1000.0, 0.1, 430.0, 483.0),
                  ...
                  child:
                    ...
                    children: <Widget>[
                      ...
                      Pinned.fromSize(
                        ...
                        fixedHeight: true,
                        child: Text(
                          venueModel !=null ? venueModel.name : history.name,
                          style: TextStyle(
                            fontFamily: 'Roboto',
                            fontSize: 22,
                        ...
                        child:
                          ...
                          children: <Widget>[
                            ...
                            Pinned.fromSize(
                              ...
                              fixedHeight: true,
                              child: Text(
                                '${venueModel !=null ? venueModel.avgSpendingTime : history.avgSpendingTime} min',
                                style: TextStyle(
                                  fontFamily: 'Roboto',
                                  fontSize: 14,
                        ...
                        child:
                          ...
                          children: <Widget>[
                            ...
                            Pinned.fromSize(
                              ...
                              fixedHeight: true,
                              child: Text(
                                '${venueModel !=null ? venueModel.areaInUse : history.areaInUse} m²',
                                style: TextStyle(
                                  fontFamily: 'Roboto',
                                  fontSize: 14,
                                  color: const Color(0xff202020),
                        ...
                        child:
                          ...
                          children: <Widget>[
                            ...
                            Pinned.fromSize(
                              ...
                              fixedHeight: true,
                              child: Text(
                                '${venueModel !=null ? venueModel.crowding : history.crowding} People',
                                style: TextStyle(
                                  fontFamily: 'Roboto',
                                  fontSize: 14,
                                  color: const Color(0xff202020),
                        ...
                        child:
                          ...
                          children: <Widget>[
                            ...
                            Pinned.fromSize(
                              ...
                              fixedHeight: true,
                              child: Text(
                                venueModel !=null ? venueModel.categoryName : history.categoryName,
                                style: TextStyle(
                                  fontFamily: 'Roboto',
                                  fontSize: 14,
                                  color: const Color(0xff757575),
                        ...
                        child:
                          ...
                          children: <Widget>[
                            Pinned.fromSize(
                              ...
                              fixedWidth: false,
                              child: Text(
                                '${venueModel !=null ? venueModel.avgSpendingTime : history.avgSpendingTime} Minutes',
                                style: TextStyle(
                                  fontFamily: 'Roboto',
                                  fontSize: 20,
                                  color: const Color(0xff202020),
