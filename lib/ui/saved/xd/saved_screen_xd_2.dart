...
class SavedScreenXD2 extends StatelessWidget {
  SavedScreenXD2({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(-344.0, 158.0, 688.0, 548.0),
            size: Size(360.0, 932.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
            child:
              ...
              children: <Widget>[
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(360.0, 0.0, 328.0, 268.0),
                  size: Size(688.0, 548.0),
                  pinRight: true,
                  pinTop: true,
                  fixedWidth: true,
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'Shoppings' (group)
                      Stack(
                    children: <Widget>[
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(0.0, 140.0, 328.0, 128.0),
                        size: Size(328.0, 268.0),
                        pinLeft: true,
                        pinRight: true,
                        pinBottom: true,
                        fixedHeight: true,
                        child:
                          ...
                          children: <Widget>[
                            ...
                            Pinned.fromSize(
                              bounds: Rect.fromLTWH(120.0, 24.0, 107.0, 19.0),
                              size: Size(328.0, 128.0),
                              fixedWidth: true,
                              fixedHeight: true,
                              child: Text(
                            ...
                            Pinned.fromSize(
                              bounds: Rect.fromLTWH(122.0, 67.0, 80.0, 17.0),
                              size: Size(328.0, 128.0),
                              fixedWidth: true,
                              fixedHeight: true,
                              child: Text(
                      ...
                      Pinned.fromSize(
                        ...
                        child:
                          ...
                          children: <Widget>[
                            ...
                            Pinned.fromSize(
                              bounds: Rect.fromLTWH(120.0, 24.0, 137.0, 19.0),
                              size: Size(328.0, 128.0),
                              fixedWidth: true,
                              fixedHeight: true,
                              child: Text(
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(0.0, 0.0, 328.0, 548.0),
                  size: Size(688.0, 548.0),
                  pinLeft: true,
                  pinTop: true,
                  pinBottom: true,
                  ...
                  child:
                    ...
                    children: <Widget>[
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(0.0, 420.0, 328.0, 128.0),
                        ...
                        child:
                          ...
                          children: <Widget>[
                            ...
                            Pinned.fromSize(
                              bounds: Rect.fromLTWH(120.0, 24.0, 29.0, 19.0),
                              size: Size(328.0, 128.0),
                              fixedWidth: true,
                              fixedHeight: true,
                              child: Text(
                      ...
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(0.0, 280.0, 328.0, 128.0),
                        size: Size(328.0, 548.0),
                        pinLeft: true,
                        pinRight: true,
                        fixedHeight: true,
                        child:
                          ...
                          children: <Widget>[
                            ...
                            Pinned.fromSize(
                              bounds: Rect.fromLTWH(120.0, 24.0, 46.0, 19.0),
                              size: Size(328.0, 128.0),
                              fixedWidth: true,
                              fixedHeight: true,
                              child: Text(
